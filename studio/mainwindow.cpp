...
MainWindow::MainWindow()
{
  ...
  connect(window.timeNowSpinBox,
          static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged),
          this,
          &MainWindow::onChangeTimeNowSpinBox);
...
{
  if (abs(DemoApi::api.getTimeStart() - timeStart) >= 1 / TimeNowSliderFactor
...
void MainWindow::onChangeTimeNowSpinBox(double timeNow) { setTimeNow(timeNow); }
