...
int selectedIndex = 0, nresolutions = 0, *widths = 0, *heights = 0, *rates = 0, nuniqueresolutions = 0;

// Supported FSAA entries;
const int nfsaa = 6;
const char* fsaa_names[] = {"1x (None)", "4x", "9x", "16x", "25x", "36x"};

const int nbuffersizes = 4;
const char* buffersize_names[] = {"128x128 px", "256x256 px", "512x512 px", "1024x1024 px"};

int
    // SFX
    sfx_program,
    sfx_handle, sfx_blockoffset_location, sfx_samplerate_location, sfx_volumelocation, sfx_texs_location, sfx_sequence_texture_location,
...
#ifdef DEBUG
    debug_output_texture_handle, debug_texture_size,
#endif
...
#ifdef MIDI
    ,
    time_dial = 0., time_fine_dial = 0., time_very_fine_dial = 0., fader0 = 0, fader1 = 0, fader2 = 0, fader3 = 0, fader4 = 0, fader5 = 0,
    fader6 = 0, fader7 = 0
#endif
    ;
...
GLuint first_pass_framebuffer = 0, first_pass_texture, second_pass_framebuffer = 0, second_pass_texture;
GLenum error;
#define NSHADERS 4.
